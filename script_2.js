const contentTemplates = {
  fashion: {
    ...
    learnMore: "Lær mere",
    contactUs: "Kontakt os for en skræddersyet strategi for jeres fashion brand",
  },
  tech: {
    ...
    learnMore: "Lær mere",
    contactUs: "Kontakt os for en skræddersyet strategi til dit tech startup",
  },
  b2b: {
    ...
    learnMore: "Lær mere",
    contactUs: "Kontakt os for en skræddersyet strategi til din B2B-virksomhed",
  },
};
...
document.getElementById("searchSimulator").addEventListener("change", function () {
  ...
  document.querySelector(".cta-button-filled").innerHTML = content.contactUs + ' <span class="arrow-2">→</span>';
});
